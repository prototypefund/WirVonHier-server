...
export function getResetPasswordBody(options: IVerificationEmailOptions): string {
  return `<!doctype html>
  <html>
    <head>
      ...
      <style>
        ...
        .cr_site {background-color:#fff;}
        .cr_header {color:#000;}
        .cr_body {color:#000;font-size:12px;}
                  ...
                  <div id="editable_content" class="cr_font">
                    <div id="3308416" rel="mce_text" class="cr_ipe_item ui-sortable">
                      <div class="mce_text">
                        <p>Lieber Händler,</p>
                        <br />
                        <p>Sie haben Ihr Passwort für Ihren Händleraccount auf <a href="https://app.wirvonhier.net" style="text-decoration:none; color:#5f6db0; font-weight:600;" title="WirVonHier Web-App">WirVonHier.net</a> vergessen? Kein Problem, klicken Sie einfach auf den unten stehenden Link, um Ihr aktuelles Passwort zurück zu setzen und wählen Sie direkt ein neues Passwort aus.</p>
                      </div>
                      <br style="clear:left;" />
                    </div>
