...
mongoimport --host mongo --db wirvonhier --collection jobs_agenda --type json --file /jobs_agenda.json -u pass -p wirvonhierpass --authenticationDatabase admin
mongoimport --host mongo --db wirvonhier --collection locations --type json --file /locations.json -u pass -p wirvonhierpass --authenticationDatabase admin
